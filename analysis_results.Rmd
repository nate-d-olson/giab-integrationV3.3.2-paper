...
```{r}
hc_vcf_df %>% filter(Key %in% c("SNPs","Insertions","Deletions", 
...
TODO -- Fraction of RefSeq coding sequence covered
TODO -- Total number of calls in highconf regions
X SNPs
X Insertions
X Deletions
X Block Substitutions
X Transition/Transversion ratio for SNVs
X Fraction phased globally or locally
...
1. Select 12 random variants (6 SNPs and 6 indels), 2 extra will currate 10. Randomly selected variants from different chromosomes. 
```{r}
